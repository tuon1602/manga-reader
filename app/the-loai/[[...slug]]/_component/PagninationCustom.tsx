  ...
  return (
    <Pagination>
      <PaginationContent className="flex gap-2">
        <PaginationItem>
          {currentPage === 1 ? null : (
            <PaginationPrevious href={`/the-loai/${slug[0]}/${currentPage - 1}`} className="border border-primary" />
          )}
        </PaginationItem>
        ...
        <PaginationItem>
          <PaginationLink
            href={`/the-loai/${slug[0]}/${totalPage}`}
        ...
        <PaginationItem>
          {currentPage === totalPage ? null : (
            <PaginationNext href={`/the-loai/${slug[0]}/${currentPage + 1}`}  className="border border-primary"/>
          )}
        </PaginationItem>
      </PaginationContent>
    </Pagination>
